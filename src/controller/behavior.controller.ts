...
export const getBehaviorCountDay = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const getBehaviorRecords = async (req: Request, res: Response): Promise<void> => {
    try {
